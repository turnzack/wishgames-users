...
local icons = {
    ...
    {id = "mesVoeux", label = "Mes Voeux", icon = "⭐", scene = "scenes.myWishes"}  -- Nouvelle icône
}
...
skipButton:addEventListener("tap", function()
    ...
    -- Modifier pour inclure la redirection vers myWishes
    local targetScene = "scenes.myWishes"  -- Par défaut, aller vers myWishes
    composer.gotoScene(targetScene, {effect = "fade", time = 1000})
end)
